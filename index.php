...
slider.oninput = function() {
  ...
  $("#addrimg").attr("src","https://chart.googleapis.com/chart?chs=260x260&cht=qr&chld=L|1&chl=bitcoin:" + addr[this.value]);
}
...
// init & fetch JSON
$.getJSON('https://api.smartbit.com.au/v1/blockchain/address/xpub661MyMwAqRbcEiNk4KqoCzFJEfqDKkoyYZ1sEkJu3G4EKJVNczpNmUq9AYrdV8RJ4Swcd3N3CtBAZwat1RrqaQycG5wkZaVRCWQC5m6UiTL?dir=dasc&limit=20').done(function(datax) {
...
function fetch5(fetch5) {
  ...
  if (fetch5.result > 0) {
    ...
    <a class="waves-effect waves-light btn-small pulse" target="_blank" href="https://tradeblock.com/bitcoin/address/${fetch5.sender}" >Output</a>`;	  
     ...
     cell2.innerHTML = `<a class="waves-effect waves-light btn-small blue" target="_blank" href="https://tradeblock.com/bitcoin/tx/${fetch5.trxn}" >Input</a>`;  
     row.setAttribute('class', 'deep-orange lighten-4');
}
  }

 <!DOCTYPE html>
  ...
  <nav>
    <div class="nav-wrapper">
      <a href="#" class="brand-logo"><i class="material-icons">done</i> BTCJUA</a>
...
function fetch5(fetch5) {
  ...
  if (fetch5.result > 0) {
   row.setAttribute('class', 'table-success');
     cell2.innerHTML = `<a class="waves-effect waves-light btn" target="_blank" href="http://btc.com/${fetch5.trxn}" >Input</a>
    <a class="waves-effect waves-light btn pulse" target="_blank" href="http://btc.com/${fetch5.sender}" >Output</a>`;	  
  } else {

   ...
   <div class="container"><div class="row"><nav>
    <div class="nav-wrapper">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li><a target="_blank" href="https://pastebin.com/raw/">Fairness</a></li>
<li><a target="_blank" href="https://bit.ly/2ARoLaP">Block Explorer</a></li>
      </ul>
    </div>
  </nav></div> </div>
...
// init & fetch JSON
$.getJSON('https://api.smartbit.com.au/v1/blockchain/address/xpub661MyMwAqRbcEaiJEUfroC7RbmFjuJMWsTSj49Tv4uSEhcddGcWVyBKKQKCu4ZKHwFKYff66HdoJ3u97RF1yCAWAnGdtHsGFJYMVsfP6ypA?dir=asc&limit=500').done(function(datax) {
 var p = 0;
...
function fetch5(fetch5) {
  ...
  if (fetch5.confirmation < 1) {
  cell2.innerHTML = `<a class="waves-effect waves-light btn-small" target="_blank" href="https://tradeblock.com/bitcoin/tx/${fetch5.trxn}" >Unconfirmed</a>`;  
  }else{
  if (fetch5.result > 0) {
